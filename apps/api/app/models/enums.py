...
class MarketplaceBindingStatus(StrEnum):
    UNBOUND = "UNBOUND"
    PREPARED = "PREPARED"
    BLOCKED = "BLOCKED"
...
class PublicationIntentType(StrEnum):
    CREATE = "CREATE"
...
class PublicationIntentStatus(StrEnum):
    PENDING = "PENDING"
    STALE = "STALE"
...
class ListingSyncState(StrEnum):
...
class ReconciliationAction(StrEnum):
    ...
    PRICE_UPDATE_REQUIRED = "PRICE_UPDATE_REQUIRED"
